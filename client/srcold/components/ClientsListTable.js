...
export const ClientsListTable = ({users}) => {
    console.log(users)
    ...
    return (
        <div className="datatable-filter-demo">
            ...
            <div className="card" >
                ...
                <DataTable value={clients} paginator //className="p-datatable p-datatable-customers" //rows={100}
                    scrollable
                    reflow="true"
                    scrollHeight="flex"
                    ...
                    column="test"
                >
                    <Column field="name" header="Name" filter filterPlaceholder="Recherche par nom" sortable style={{ minWidth: '12rem' }} />
                    <Column header="Country" filterField="country.name" sortable style={{ justifyContent: 'space-between'/*minWidth: '12rem'*/ }} body={countryBodyTemplate} filter filterPlaceholder="Recherche par pays" />
